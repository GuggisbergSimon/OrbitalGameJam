...
public class LevelSpawnTrack : MonoBehaviour
{
	...
	public List<Tuple<float, GameObject>> createLevel1()
	{
		return new List<Tuple<float, GameObject>>
		{
			...
			addElem(27.2142857142857f, false, Ennemy.EnnemyType.Bottom),
			addElem(27.3214285714286f, true, Ennemy.EnnemyType.Bottom),
			...
			addElem(36.1071428571429f, true, Ennemy.EnnemyType.RightOrLeft),
			addElem(36.2142857142857f, false, Ennemy.EnnemyType.RightOrLeft),
			addElem(36.3214285714286f, true, Ennemy.EnnemyType.RightOrLeft),
			...
			addElem(37.3928571428571f, true, Ennemy.EnnemyType.RightOrLeft),
			addElem(37.5f, false, Ennemy.EnnemyType.RightOrLeft),
			addElem(37.6071428571429f, true, Ennemy.EnnemyType.RightOrLeft),
			...
			addElem(38.6785714285714f, true, Ennemy.EnnemyType.RightOrLeft),
			addElem(38.7857142857143f, false, Ennemy.EnnemyType.RightOrLeft),
			addElem(38.8928571428571f, true, Ennemy.EnnemyType.RightOrLeft),
			...
			addElem(40.8214285714286f, true, Ennemy.EnnemyType.RightOrLeft),
			addElem(40.9285714285714f, false, Ennemy.EnnemyType.RightOrLeft),
			addElem(41.0357142857143f, true, Ennemy.EnnemyType.RightOrLeft),
			...
			addElem(53.25f, false, Ennemy.EnnemyType.Bottom),
			addElem(53.3571428571429f, true, Ennemy.EnnemyType.Bottom),
			addElem(53.4642857142857f, false, Ennemy.EnnemyType.Bottom),
			addElem(53.5714285714286f, true, Ennemy.EnnemyType.Bottom),
			addElem(53.6785714285714f, false, Ennemy.EnnemyType.Bottom),
			addElem(53.7857142857143f, true, Ennemy.EnnemyType.Bottom),
			addElem(53.8928571428571f, false, Ennemy.EnnemyType.Bottom), addElem(54f, true, Ennemy.EnnemyType.Bottom),
			addElem(54.1071428571429f, false, Ennemy.EnnemyType.Bottom),
			addElem(54.2142857142857f, true, Ennemy.EnnemyType.Bottom),
			addElem(54.3214285714286f, false, Ennemy.EnnemyType.Bottom),
			addElem(54.5357142857143f, false, Ennemy.EnnemyType.Bottom),
			addElem(54.6428571428571f, true, Ennemy.EnnemyType.Bottom), addElem(54.75f, false, Ennemy.EnnemyType.Bottom)
		};
	}
